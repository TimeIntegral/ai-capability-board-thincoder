...
for (const suite of suites) {
  ...
  try {
    const out = execFileSync(process.execPath, [path.join(target, 'tools', suite)], { cwd: target, env, encoding: 'utf8', timeout: 600000, maxBuffer: 32 * 1024 * 1024, windowsHide: true });
